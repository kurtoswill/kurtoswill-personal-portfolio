                    ...
                    {competitions.map((competition) => (
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-3 sm:gap-4 text-left'>
                                <h1 className='text-[24px] sm:text-[28px] md:text-[32px] font-semibold leading-tight'>{competition.name}</h1>
                                <p className='text-sm sm:text-base'>{competition.year}</p>
                                <p className='text-sm sm:text-base opacity-50'>{competition.description}</p>
